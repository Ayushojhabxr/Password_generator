 ...
 let lengthDisplay =document.querySelector('.length');
  ...
  let copyBtn = document.querySelector('.copybutton');
   ...
   let indicator = document.querySelector('.circle');

   let generateBtn = document.querySelector('.password_generate');
...
setIndicator("#ccc"); // for indicator
//Functions

// for slider = it sets passwd length
...
// click ebent on generate button 
